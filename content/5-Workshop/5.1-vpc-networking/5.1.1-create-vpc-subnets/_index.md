...
![Create VPC on AWS Console](/images/5-Workshop/5.1.1/create_vpc.png)
...
![Create Public Subnet 1](/images/5-Workshop/5.1.1/create_public_subnet_1.png)
...
![Create Public Subnet 2](/images/5-Workshop/5.1.1/create_public_subnet_2.png)

5. Continue clicking **Add new subnet** to create the 2 Private Subnets similarly:
...
6. Once all 4 Subnets are defined, scroll down and click **Create subnet**.

![Create Private Subnets](/images/5-Workshop/5.1.1/create_private_subnets.png)
...
![Enable Auto-assign public IP](/images/5-Workshop/5.1.1/enable_auto_assign_ip.png)
